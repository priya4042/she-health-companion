...
class _MoodJournalScreenState extends State<MoodJournalScreen> {
  ...
  static const _moods = [
    {'emoji': '😢', 'label': 'Terrible', 'score': 1, 'color': Color(0xFFEF5350)},
    {'emoji': '😔', 'label': 'Bad', 'score': 2, 'color': Color(0xFFFF7043)},
    {'emoji': '😐', 'label': 'Okay', 'score': 3, 'color': Color(0xFFFFCA28)},
    {'emoji': '😊', 'label': 'Good', 'score': 4, 'color': Color(0xFF66BB6A)},
    {'emoji': '🤩', 'label': 'Great', 'score': 5, 'color': Color(0xFF42A5F5)},
  ];

  static const _tags = [
    'Work', 'Exercise', 'Sleep', 'Social', 'Health',
    'Food', 'Family', 'Travel', 'Study', 'Relax',
  ];
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  "Today you're feeling ${today.moodLabel}",
  ...
  Future<void> _saveMood(BuildContext context, MoodProvider mood) async {
    ...
    if (context.mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text('Mood saved! Keep tracking your feelings.'),

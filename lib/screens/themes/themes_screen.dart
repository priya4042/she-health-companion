...
class _ThemesScreenState extends State<ThemesScreen> {
  ...
  static const List<Map<String, dynamic>> _themes = [
    {'id': 'default', 'name': 'Rose Pink', 'colors': [0xFFE91E8C, 0xFF9C27B0], 'icon': '🌹', 'cost': 0},
    {'id': 'lavender', 'name': 'Lavender Dream', 'colors': [0xFF7C4DFF, 0xFFB388FF], 'icon': '💜', 'cost': 0},
    {'id': 'mint', 'name': 'Fresh Mint', 'colors': [0xFF26A69A, 0xFF80CBC4], 'icon': '🌿', 'cost': 50},
    {'id': 'coral', 'name': 'Coral Sunset', 'colors': [0xFFFF6B6B, 0xFFFF8A65], 'icon': '🌅', 'cost': 50},
    {'id': 'ocean', 'name': 'Ocean Blue', 'colors': [0xFF1565C0, 0xFF42A5F5], 'icon': '🌊', 'cost': 100},
    {'id': 'golden', 'name': 'Golden Hour', 'colors': [0xFFFF8F00, 0xFFFFCA28], 'icon': '✨', 'cost': 100},
    {'id': 'cherry', 'name': 'Cherry Blossom', 'colors': [0xFFEC407A, 0xFFF8BBD0], 'icon': '🌸', 'cost': 150},
    {'id': 'midnight', 'name': 'Midnight Galaxy', 'colors': [0xFF1A237E, 0xFF7C4DFF], 'icon': '🌌', 'cost': 200},
    {'id': 'forest', 'name': 'Enchanted Forest', 'colors': [0xFF2E7D32, 0xFF66BB6A], 'icon': '🌲', 'cost': 200},
    {'id': 'royal', 'name': 'Royal Purple', 'colors': [0xFF6A1B9A, 0xFFCE93D8], 'icon': '👑', 'cost': 300},
    {'id': 'rainbow', 'name': 'Rainbow Burst', 'colors': [0xFFE91E63, 0xFFFF9800, 0xFF4CAF50, 0xFF2196F3], 'icon': '🌈', 'cost': 500},
  ];

  @override
  void initState() {
    super.initState();
    _selectedTheme = _settingsBox.get(AppConstants.keyCustomTheme, defaultValue: 'default');
  }
              ...
              child: Row(
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('Your Points', style: TextStyle(fontSize: 13, color: Colors.grey)),
                      Text('$points points',
                          style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: AppColors.moodColor)),
                    ],
                  ),
                  const Spacer(),
                  const Text('Earn points by\ncompleting challenges',
                  ...
                  onTap: () {
                    if (!isUnlocked) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('Need $cost points to unlock this theme (you have $points)')),
                      );
                      return;
                    }

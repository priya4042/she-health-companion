...
class _PeriodTrackerScreenState extends State<PeriodTrackerScreen> {
      ...
      child: Column(
        children: [
          ...
          if (cycleDay != null) ...[
            ...
            Text(
              'Cycle day $cycleDay of ${period.cycleLength}',
              style: TextStyle(
          ...
          if (period.nextPeriodDate != null) ...[
            ...
            Text(
              'Next: ${AppDateUtils.formatDate(period.nextPeriodDate!)}',
              style: TextStyle(
  ...
  Widget _buildSymptomSection(BuildContext context, PeriodProvider period) {
    ...
    final symptomTypes = ['Pain', 'Cramps', 'Mood', 'Bloating', 'Headache'];
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(
                'Symptoms - ${AppDateUtils.formatDateShort(_selectedDay!)}',
                style:
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _SummaryRow(
            label: 'Average cycle',
            value: '${period.averageCycleLength.toStringAsFixed(1)} days',
          ),
          _SummaryRow(
            label: 'Total records',
